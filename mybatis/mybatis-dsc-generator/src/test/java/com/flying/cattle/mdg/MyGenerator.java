...
public class MyGenerator {
		...
		public static final String URL = "jdbc:mysql://localhost:3306/finance_voucher?useSSL=false&serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf8";
		public static final String NAME = "root";
		public static final String PASS = "password";
		public static final String DATABASE = "finance_voucher";
		// 类信息：类名、对象名（一般是【类名】的首字母小些）、类说明、时间
		public static final String CLASSNAME = "currency";
		public static final String TABLE = "t_currency";
